...
// CONTRASEÑA DE REGISTRO.-------------------------------------------
 include("../conexionphp/principal.php");
...
$consulta = "UPDATE eaglecopters.usuarios SET pass = '$hash' WHERE usuarios.mail='$email'"; 
...
try {
    ...
    $mail->Password   = 'Familia2009.';                               // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom('conisepu09@gmail.com', 'Reestablecimiento de Password');
    ...
    $mail->Subject = 'Reestablecimiento de PASSWORD de usuario';

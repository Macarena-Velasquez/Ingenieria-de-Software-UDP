...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2020 a las 21:53:47
...
CREATE TABLE `cliente` (
  ...
  `Apuntes` varchar(1024) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `administrador`
  ADD CONSTRAINT `administrador_ibfk_1` FOREIGN KEY (`datosID`) REFERENCES `users` (`ID`);
...
--
ALTER TABLE `ejecutivos`
  ADD CONSTRAINT `ejecutivos_ibfk_1` FOREIGN KEY (`datosID`) REFERENCES `users` (`ID`);

--
-- Filtros para la tabla `empresa`
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `empresa_ibfk_1` FOREIGN KEY (`rubroID`) REFERENCES `rubro` (`ID`);
COMMIT;
